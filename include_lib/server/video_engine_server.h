...
typedef struct video_engine_req {
    ...
    union {
        ...
        ve_face_detect_params_t face_detect_params;
...
//vehicle_detect_flag = 1: vehicle detect open
//vehicle_detect_flag = 0: vehicle detect close
//improv_vehicle_detect_flag = 1: improv the accuracy vehicle detect
//improv_vehicle_detect_flag = 0: just hog vehicle detect
extern void vehicle_detect_open_close(int vehicle_detect_flag, int improv_vehicle_detect_flag);
