...
int ispt_set_hdr(isp_hdr_t *p);
int ispt_get_hdr(isp_hdr_t *p);

int ispt_set_rgbir(isp_rgbir_t *p);
int ispt_get_rgbir(isp_rgbir_t *p);
...
int ispt_set_bnr(isp_bnr_t *p);
int ispt_get_bnr(isp_bnr_t *p);
...
int ispt_set_ltmo(isp_ltmo_t *p);
int ispt_get_ltmo(isp_ltmo_t *p);
...
int ispt_set_hsv(isp_hsv_t *p);
int ispt_get_hsv(isp_hsv_t *p);
...
int ispt_set_drc_hist(isp_drc_hist_t p);
int ispt_get_drc_hist(isp_drc_hist_t *p);

int ispt_set_drc_wdr(isp_wdr_t p);
int ispt_get_drc_wdr(isp_wdr_t *p);
