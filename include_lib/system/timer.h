...
int sys_timer_add_to_task(char *task_name, void *priv, void (*func)(void *priv), u32 msec);

int sys_timeout_add_to_task(char *task_name, void *priv, void (*func)(void *priv), u32 msec);
