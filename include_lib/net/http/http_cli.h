...
httpin_error httpscli_init(httpcli_ctx *ctx);

int httpscli_read(httpcli_ctx *ctx, char *recvbuf, unsigned int len);

void httpscli_close(httpcli_ctx *ctx);
