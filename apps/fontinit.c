...
REGISTER_LANGUAGE_BEGIN(Chinese_Simplified_24) = {
    .language_id = Chinese_Simplified,
    .flags = FONT_SHOW_PIXEL | FONT_SHOW_MULTI_LINE,
    .pixel.file.name = (char *)"mnt/spiflash/res/F_GB2312_24.PIX",
    .ascpixel.file.name = (char *)"mnt/spiflash/res/F_ASCII_24.PIX",
    .tabfile.name = (char *)"mnt/spiflash/res/F_GB2312.TAB",
    .isgb2312 = true,
    .bigendian = false,
    .putchar = platform_putchar,
