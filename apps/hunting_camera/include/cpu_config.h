...
#define VIDEO0_REC_FORMAT  VIDEO_FMT_AVI// VIDEO_FMT_MOV  //VIDEO_FMT_AVI
...
#define USB_CAMERA_BUF_SIZE (5 * 1024 * 1024) // + 512 * 1024)
#define CAMERA_CAP_BUF_SIZE (8 * 1024 * 1024+128*1024)
...
#define VIDEO1_REC_FORMAT   VIDEO_FMT_AVI//VIDEO_FMT_MOV
#define VIDEO2_REC_FORMAT   VIDEO_FMT_AVI
#define VIDEO3_REC_FORMAT   VIDEO_FMT_AVI//VIDEO_FMT_MOV
...
#define USB_CAMERA_BUF_SIZE (6 * 1024 * 1024) // + 512 * 1024)
#define CAMERA_CAP_BUF_SIZE (9 * 1024 * 1024)
