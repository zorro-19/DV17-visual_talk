...
//    if (!strcmp(it->data, "decode_mov_preview")) {
//        /*
//         * 解码测试
//         */
//        u8 *decode_buf =NULL;
//        decode_buf = malloc(20*1024);
//        void decode_mov_preview(u8* path,u8* buf,u32 left,u32 top,u32 width,u32 height,u32 size);
//        decode_mov_preview(CONFIG_REC_PATH_0"1.JPG",decode_buf,304,128,128,80,20*1024);
//        delay_2ms(50);
//        decode_mov_preview(CONFIG_REC_PATH_0"1.JPG",decode_buf,304,240,128,80,20*1024);
//        free(decode_buf);
//    }
