...
#define VREC0_FBUF_SIZE     (4 * 1024 * 1024)//(2*1024*1024)
#else
#define VREC0_FBUF_SIZE     (0 * 1024 * 1024)//(2*1024*1024)
#endif // CONFIG_VIDEO0_ENABLE


#ifdef CONFIG_VIDEO1_ENABLE
#define VREC1_FBUF_SIZE     (4 * 1024 * 1024)//(2*1024*1024)
#else
#define VREC1_FBUF_SIZE     (0 * 1024 * 1024)//(2*1024*1024)
#endif // CONFIG_VIDEO1_ENABLE


#ifdef CONFIG_VIDEO2_ENABLE
#define VREC2_FBUF_SIZE     (4 * 1024 * 1024)//(2*1024*1024)
#else
#define VREC2_FBUF_SIZE     (0 * 1024 * 1024)//(2*1024*1024)
#endif // CONFIG_VIDEO2_ENABLE



#ifdef CONFIG_VIDEO3_ENABLE
#define VREC3_FBUF_SIZE     (4 * 1024 * 1024)//(2*1024*1024)
#else
#define VREC3_FBUF_SIZE     (0 * 1024 * 1024)//(2*1024*1024)
...
#define USB_CAMERA_BUF_SIZE (1 * 1024 * 1024) // + 512 * 1024)
#define CAMERA_CAP_BUF_SIZE (0)//(1 * 1024 * 1024)

#define NET_VREC0_FBUF_SIZE    (256 * 1024)//(1 * 1024 * 1024)
#define NET_AUDIO_BUF_SIZE      (128 * 1024)
...
#define VREC3_FBUF_SIZE     (0)//(1*1024*1024 + 512*1024)
// #define VREC4_FBUF_SIZE     (0*1024*1024)
#define AUDIO_BUF_SIZE      (128*1024)//(300*1024)

#define USB_CAMERA_BUF_SIZE (1 * 1024 * 1024) // + 512 * 1024)

#define CAMERA_CAP_BUF_SIZE (0)//(2 * 1024 * 1024)
