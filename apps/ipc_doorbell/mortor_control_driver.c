...
#ifdef IPC_50_NUMBER_TEST_DEMO
#define PORT_0  IO_PORTH_00//IO_PORTG_12//IO_PORTH_02  //蓝色线
#define PORT_1  IO_PORTH_01//IO_PORTG_13//IO_PORTH_03  //棕色线
#define PORT_2   IO_PORTH_04//IO_PORTG_14//IO_PORTH_04  //黄色线
#define PORT_3  IO_PORTH_05//IO_PORTG_15//IO_PORTH_05  //黑色线
#else
#define PORT_0  -1//IO_PORTG_12//IO_PORTH_02  //蓝色线
#define PORT_1  -1//IO_PORTG_13//IO_PORTH_03  //棕色线
#define PORT_2   -1//IO_PORTG_14//IO_PORTH_04  //黄色线
#define PORT_3  -1//IO_PORTG_15//IO_PORTH_05  //黑色线
#endif
#endif

#if (defined IPC_50_NUMBER_TEST_DEMO|| defined XD_CONFIG_BOARD_DEV_WIFI_5713_20231208) //xd define
...
#define PORT_4  IO_PORTH_00   //蓝色线    IO_PORTH_01  //棕色线       蓝色线
#define PORT_5  IO_PORTH_01  //棕色线  IO_PORTH_05  //黑色线       棕色线
#define PORT_6  IO_PORTH_04  //黄色线  IO_PORTH_00   //蓝色线      黄色线
#define PORT_7  IO_PORTH_05  //黑色线 IO_PORTH_04  //黄色线       黑色线
...
//extern void delay_2ms(int cnt);
#define   DELAY_TIME(speed)           delay_2ms(speed)//;delay_us(speed)
...
static void step_motor_foreward(int speed);
static void step_motor_rollback(int speed);
...
static void step_motor_up_direction(int speed);
static void step_motor_down_direction(int speed);
...
static void step_motor_rollback(int speed)
{
   ...
   step_motor_lf_rollback_output(MotorStepCount);
	DELAY_TIME(speed);// delay_2ms(speed);
}
...
#define PORT_XD1  IO_PORTH_00  //蓝色线
#define PORT_XD2  IO_PORTH_01//棕色线
#define PORT_XD3  IO_PORTH_04   //黄色线
#define PORT_XD4  IO_PORTH_05  //黑色线
...
static void step_motor_ud_a_output(void)
{
	...
	gpio_direction_output(PORT_XD1,0);
	gpio_direction_output(PORT_XD2,0);
	gpio_direction_output(PORT_XD3,0);
	gpio_direction_output(PORT_XD4,1);
...
static void step_motor_ud_ab_output(void)
{
    gpio_direction_output(PORT_XD1,0);
	gpio_direction_output(PORT_XD2,0);
	gpio_direction_output(PORT_XD3,1);
	gpio_direction_output(PORT_XD4,1);
}
...
static void step_motor_ud_b_output(void)
{
	...
	gpio_direction_output(PORT_XD2,0);
	gpio_direction_output(PORT_XD3,1);
	gpio_direction_output(PORT_XD4,0);
}
...
{
    gpio_direction_output(PORT_XD1,0);
	gpio_direction_output(PORT_XD2,1);
	gpio_direction_output(PORT_XD3,1);
	gpio_direction_output(PORT_XD4,0);
}
//========================================================================
...
static void step_motor_ud_cd_output(void)
{
    gpio_direction_output(PORT_XD1,1);
	gpio_direction_output(PORT_XD2,1);
	gpio_direction_output(PORT_XD3,0);
	gpio_direction_output(PORT_XD4,0);
}
...
// 详述:
//========================================================================
void step_motor_drive(uint8 dire,int speed,int angle,u8 point_step)
{
   ...
   switch(dire)
    {
		 ...
		 #else
             #ifndef IPC_50_NUMBER_TEST_DEMO //hb 自定义模组接口
...
void  turn_360_degree(uint8 dire,int speed,int angle,u8 point_step ){
