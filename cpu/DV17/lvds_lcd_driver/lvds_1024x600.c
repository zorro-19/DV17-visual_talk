...
#ifdef LCD_LVDS_1024x600

static void lcd_lvds_1024x600_backctrl(void *_data, u8 on)
{
...
REGISTER_LVDS_DEVICE_BEGIN(lvds_1024x600_dev_t) = {
    .info = {
        .test_mode 	     = false,
...
static int lcd_lvds_1024x600_init(void *_data)
{
    printf("lvds 1024x600 init.\n");
    return 0;
}

REGISTER_LCD_DEVICE_DRIVE(lcd_dev)  = {
    .type    = LCD_LVDS,
    .init    = lcd_lvds_1024x600_init,
    .dev     = &lvds_1024x600_dev_t,
    .bl_ctrl = lcd_lvds_1024x600_backctrl,
};
