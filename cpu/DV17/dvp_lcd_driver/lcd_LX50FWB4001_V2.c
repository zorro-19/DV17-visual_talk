...
//PV5 CS     Pin40
#define SPI_CSX_OUT()   PORTD_DIR &=~ BIT(11)
#define SPI_CSX_H()     PORTD_OUT |=  BIT(11)
#define SPI_CSX_L()     PORTD_OUT &=~ BIT(11)

//PV6 SCL    Pin39
#define SPI_SCL_OUT()   PORTD_DIR &=~ BIT(9)
#define SPI_SCL_H()     PORTD_OUT |=  BIT(9)
#define SPI_SCL_L()     PORTD_OUT &=~ BIT(9)

//PV7 SDA    Pin38
#define SPI_SDA_OUT()   PORTD_DIR &=~ BIT(8)
#define SPI_SDA_IN()    PORTD_DIR |=  BIT(8)
#define SPI_SDA_H()     PORTD_OUT |=  BIT(8)
#define SPI_SDA_L()     PORTD_OUT &=~ BIT(8)
#define SPI_SDA_R()     PORTD_IN   &  BIT(8)
...
static void lcd_lx50fwb4001_v2_init(void *_data)
{
    ...
    printf("lcd_lx50fwb4001_v2 init...\n");
...
REGISTER_IMD_DEVICE_BEGIN(lcd_lx50fwb4001_v2_dev) = {
    .info = {
        .test_mode 	     = false,
