...
isd_download.exe -cfg %a% -input uboot.boot ver.bin sdram.apu -resource res audlogo 32 -bfumode %bfumode% -disk file -aline 4096 -dev upgrade_bfu -key 560-hbwy-AC521X-B3D8.key
