...
//	.output_channel = OUTPUT_CHANNEL0,
//#endif
//	.tx_pin =IO_PORTG_13,//  IO_PORTH_06,  //
//	.rx_pin =IO_PORTG_09,//  IO_PORTH_06,  //
//  	.flags = UART_DEBUG,
...
//不用的PR口拉高
    ...
    gpio_direction_input(IO_PORTE_01);
    gpio_direction_input(IO_PORTE_00);
