...
extern u32 GC2053_mipi_calc_shutter(isp_ae_shutter_t *shutter, u32 exp_time_us, u32 gain);
extern u32 GC2053_mipi_set_shutter(isp_ae_shutter_t *shutter);
extern void  *GC2053_mipi_get_ae_curve(u32 type, u32 fps, int *min_ev, int *max_ev);
...
static isp_ae_params_t  GC2053_mipi_ae_params = {
    ...
    .ae_ops = {
        .calc_shutter = GC2053_mipi_calc_shutter,
        .set_shutter  = GC2053_mipi_set_shutter,
        .get_ae_curve = GC2053_mipi_get_ae_curve,
    },
...
void GC2053_mipi_ae_ev_init(u32 fps)
{
    u32 time, gain;
    int minev, maxev;
    ...
    ae_curve = GC2053_mipi_get_ae_curve(AE_CURVE_TYPE, fps, &minev, &maxev);
    isp_ae_curve_interp(ae_curve, AE_INIT_EV, &time, &gain);

    GC2053_mipi_calc_shutter(&ae_shutter, time, gain);

    GC2053_mipi_set_shutter(&ae_shutter);
}


void   *GC2053_mipi_get_ae_curve(u32 type, u32 fps, int *min_ev, int *max_ev)
{
    const void *curve;
...
void *GC2053_MIPI_get_ae_params()
{
