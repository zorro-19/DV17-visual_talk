...
#ifndef __SC2313_DVP_AE_H__
#define __SC2313_DVP_AE_H__
...
#define AE_TARGET_LUMA              6*16

#define AE_PHASE_COMP               3

#define AE_LUMA_SMOOTH_NUM          5

#define AE_CONVER_H                 5*2
#define AE_CONVER_L                 5*2

#define AE_DIVER_H                  8*2
#define AE_DIVER_L                  8*2
