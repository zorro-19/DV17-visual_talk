...
#ifndef __HM2131_MIPI_AE_H__
#define __HM2131_MIPI_AE_H__

#include "typedef.h"



#define AE_MAX_EV                   (9102000/3)
//#define AE_MAX_EV                   (546120)
#define AE_MIN_EV                   100 //((1<<5)*16)
