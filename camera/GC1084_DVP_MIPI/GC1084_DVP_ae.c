...
extern u32 GC1084_DVP_set_shutter(isp_ae_shutter_t *shutter);
...
void GC1084_DVP_ae_ev_init(u32 fps)
{
    u32 time, gain;
    int minev, maxev;
    ...
    GC1084_DVP_calc_shutter(&ae_shutter, time, gain);

    GC1084_DVP_set_shutter(&ae_shutter);
}
